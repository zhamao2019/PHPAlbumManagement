...
$albums = getSharedAlbumsByUserId($_GET['friendId']);
$albumId = $_GET['album'];
...
<div class="container">
    <form method = "post" action = "FriendPictures.php?friendId=<?php echo $friendId.'&album='.$albumId.'&pictureId='.$pictureIdGet; ?>">
        <div style="margin-top:30px"><h1><strong><?php  echo $rowName;?>'s Pictures</strong></h1></div><br/>
        <div class="row">
                ...
                <div style ='overflow-x:scroll; overflow-y:hidden; display: inline-block; width: 600px;padding: 5px; margin-top: 10px; height: 120px; border: 1px solid gainsboro; white-space:nowrap'  id="thumbnail">
                    ...
                    if(isset($_GET['album'])&&$_GET['album']!="-1"){
                        ...
                        foreach ($pictures as $p){
                            ...
                            echo  "<a style='margin-right:5px;' href='FriendPictures.php?friendId=".$friendId."&album=".$_GET['album']
